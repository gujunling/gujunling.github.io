...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "GitHub部署及推送", link: "/pages/cb910b/" },
    ...
    author: {
      name: "sweetheart", // 必需
      link: "https://github.com/gujunling", // 可选的
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:gujunq1998@163.com',
        },
        {
  ...
  head: [
    ...
    ['meta', { name: 'baidu-site-verification', content: 'code-53yMawG36P' }], // 百度统计的站长验证
    ['meta', { name: 'google-site-verification', content: 'C6GIWT5zHwhVsd3ufgcZIlut2hsQwK6P4MSuHLz2SyA' }], // 谷歌收录文章的HTML标签验证
