...
**若按照此文章配置不成功的情况下，可以将 nginx 服务删除，然后重新安装，在安装时配置安装 http_ssl_module 模块，具体可参考我的文章[https://sweetheartjq.com/pages/3cce56/](https://sweetheartjq.com/pages/3cce56/)**
...
centos7 安装配置 nginx 服务：[https://sweetheartjq.com/pages/3cce56/](https://sweetheartjq.com/pages/3cce56/)
